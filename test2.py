...
# Function to create a vector database from a PDF and populate Neo4j graph database
def create_vector_db():
    vectordb_file_path = "faiss_index"  
    
    # Reading texts from a PDF file
    pdfreader =  PdfReader(r"C:\Users\ASUS\Downloads\noBSLA_v2_preview.pdf")
    raw_text = ""
...
print(chain("what is linear algebra"))
