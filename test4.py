...
# Function to create a vector database from a Word document and populate Neo4j graph database
def create_vector_db():
    vectordb_file_path = "faiss_index"

    # Reading texts from Word document
    doc = Document(r"C:\Users\ASUS\Desktop\POC\sample document file.docx")
    raw_text = ""
...
def get_qa_chain(vectordb_file_path):
    ...
    In the answer, try to provide as much text as possible without making many changes.
...
print(chain("what is html frame"))
